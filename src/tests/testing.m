...
[P_X5, P_Y5, P_Z5] = trajectoryLib.get_board_location(9, 13, 0, 0);
...
move_cube_coord(arm, trajectoryLib, P_X6, P_Y6, (P_Z6+0.025-constant), P_X1, P_Y1, (P_Z1+0.025+0.017-constant), 0.001, -0.002);

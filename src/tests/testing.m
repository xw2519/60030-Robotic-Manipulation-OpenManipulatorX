...
[P_X1, P_Y1, P_Z1] = trajectoryLib.get_board_location(12, 9, 0.004, 0);
[P_X2_2, P_Y2_2, P_Z2_2] = trajectoryLib.get_board_location(8, 4, 0.005, 0);
[P_X2, P_Y2, P_Z2] = trajectoryLib.get_board_location(8, 4, 0, 0);
[P_X3, P_Y3, P_Z3] = trajectoryLib.get_board_location(6, 1, 0.004, 0);
[P_X4, P_Y4, P_Z4] = trajectoryLib.get_board_location(3, 15, 0, 0);
...
%rotate_cube_backward_at_coord(arm, trajectoryLib, P_X1, P_Y1, P_Z1+0.025-constant, x_offset0, z_offset0);
%rotate_cube_backward_at_coord(arm, trajectoryLib, P_X1, P_Y1, P_Z1+0.025-constant, x_offset0, z_offset0);
...
%rotate_cube_backward_at_coord(arm, trajectoryLib, P_X3, P_Y3, P_Z3+0.025-constant, x_offset1, z_offset1);
%rotate_cube_backward_at_coord(arm, trajectoryLib, P_X5, P_Y5, P_Z5+0.025-constant, x_offset2, z_offset2);

set_all_servo_speed_limits(arm, 40);
set_all_servo_acceleration_limits(arm, 14);

move_cube_coord(arm, trajectoryLib, P_X6, P_Y6, (P_Z6+0.025-constant), P_X1, P_Y1, (P_Z1+0.025+0.017-constant), 0-0.001, -0.002);
move_cube_coord(arm, trajectoryLib, P_X1, P_Y1, (P_Z1+0.025+0.0098-constant), P_X3, P_Y3, (P_Z3+0.025+0.017-constant), 0.002, -0.002);
move_cube_coord(arm, trajectoryLib, P_X3, P_Y3, (P_Z3+0.025+0.005-constant), P_X5, P_Y5, (P_Z5+0.025+0.017-constant), 0.002, -0.002);
%move_cube_coord(arm, trajectoryLib, P_X5, P_Y5, (P_Z3+0.025+0.0098-constant), P_X2, P_Y2, (P_Z2+0.025+0.017-constant), 0, 0);
...
%move_cube_coord(arm, trajectoryLib, P_X3, P_Y3, (P_Z3+0.025+0.0098-constant-0.005), P_X2, P_Y2, ((P_Z2+0.025+0.025+0.017-constant)), x_offset, z_offset);
%move_cube_coord(arm, trajectoryLib, P_X5, P_Y5, (P_Z5+0.025+0.0098-constant-0.005), P_X2, P_Y2, (P_Z2+0.025+0.025+0.025+0.017-constant), x_offset, z_offset);

...
Y_COORDS_INIT = linspace(0, -0.05, 25);
...
Y_COORDS = linspace(0.05, -0.05, 20);
...
for i = 1:length(THETA_MATRIX)
    ...
    % Display arm coordinates
    str = {['X = ', num2str(ARM_COORDINATES_X(5))], ['Y = ', num2str(ARM_COORDINATES_Y(5))], ['Z = ', num2str(ARM_COORDINATES_Z(5))], [], ['\theta_1 = ',num2str(THETA_1)],['\theta_2 = ',num2str(THETA_2)],['\theta_3 = ',num2str(THETA_3)],['\theta_4 = ',num2str(THETA_4)], ['\phi = ', num2str(PHI)]};
...
XYZ_COORDS = flip([(X_COORDS(1)*ones(1,20)).'  (Y_COORDS).'   (Z_COORDS(1)*ones(1,20)).'  ]); 
